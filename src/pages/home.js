        ...
        <section id="articles">
          <article>
            ...
            <p>
              ...
              avoiding obstacles to achieve high scores. <br />
            </p>
            <br />
            <p>
            ...
            <p>
              ...
              <a
                className="button"
                href="https://github.com/antoheri/duckdash-presentation"
              >
                {" "}
                GitHub - React{" "}
              </a>
              ...
              <a
                className="button"
                href="https://github.com/Yannchri/duck-dash"
              >
                {" "}
                GitHub - Game{" "}
              </a>
              ...
              <a
                className="button"
                href="https://www.antoheri.ch/duck-dash/index.html"
                target="_blank"
              >
                {" "}
                Game{" "}
